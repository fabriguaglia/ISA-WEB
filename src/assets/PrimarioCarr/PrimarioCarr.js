          ...
          <div className="carousel-inner">
            <div className="carousel-item active">
              ...
              <div className="carousel-caption">
                ...
                <p className='text-shadow fs-5  bg-dark bg-gradient bg-opacity-75'>Transformar las caracteristicas del niño actual en un individuo con conocimientos aplicables a la realidad.</p>
            ...
            <div className="carousel-item">
              ...
              <div className="carousel-caption">
                <p className='text-shadow fs-5  bg-dark bg-gradient bg-opacity-75'>Promovemos el desarrollo de habilidades fundamentales, el pensamiento crítico y el amor por el aprendizaje, preparando a los estudiantes para un futuro brillante.</p>
              </div>
            </div>
          </div>
