  ...
  return (
    <>
      <div className="container-fluid navbarprincipal d-flex justify-content-between align-items-center">
        ...
        <div className="d-flex align-items-center">
          <button type="button" className="btn textcolor" href="/blog">Blog</button>
          <button type="button" className="btn textcolor" href="https://login.microsoftonline.com/">Office 365</button>
          <button type="button" className="btn btn-danger textcolor" href="https://www.santillanaconnect.com/Account/Login/">AulaVirtual</button>
        </div>
      </div>
            ...
            <div className="offcanvas-body">
              <ul className="navbar-nav justify-content-end flex-grow-1 pe-3">
                <li className="nav-item">
                  <a className="nav-link active" aria-current="page" href="#">Contacto y Soporte</a>
                </li>
                <li className="nav-item">
